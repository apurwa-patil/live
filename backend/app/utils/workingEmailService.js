...
export const sendVerificationEmail = async (email, token) => {
  ...
  try {
    ...
    if (error.code === 'EAUTH') {
      ...
      console.log('   1. Check EMAIL_USER is correct in .env');
      console.log('   2. Check EMAIL_PASS is correct (your 8-character app password)');
