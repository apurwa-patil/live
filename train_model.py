...
csv_path = BASE_DIR / "backend" / "data" / "Marathi_Folksongs.csv"
...
joblib.dump(vectorizer, 'backend/ml_models/tfidf_vectorizer.pkl')
joblib.dump(classifier, 'backend/ml_models/title_classifier.pkl')
joblib.dump(le, 'backend/ml_models/title_encoder.pkl')
joblib.dump(metadata_map, 'backend/ml_models/metadata_map.pkl')
